<?php
	/**
	 * @desc  旅游资讯类别表
	 * Class TblTourCategoryModule
	 * Author Zf
	 */
class TblTourCategoryModule extends  CommonModule{

	public $KeyID = 'CategoryID';
	public $TableName = 'tbl_tour_categories';
	...
	public function UpdateInfo($Data,$CategoryID){
		global $DB;
		if($CategoryID=='' || !is_array($Data)){
			return 0;
		}
		return $DB->updateWhere($this->TableName,$Data,'CategoryID=\''.intval($CategoryID).'\'');
	}
