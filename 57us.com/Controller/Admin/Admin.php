...
class Admin
{
    ...
    public function Index()
    {
        if ($_SESSION['AdminID'] && $_SESSION['AdminName']) {
            header("Location:" . WEB_ADMIN_URL . "/index.php?Module=TourArea&Action=TourAreaList");
        } else {
    ...
    {
        include SYSTEM_ROOTPATH . '/Modules/Admin/Class.AdminAdminModule.php';
        ...
        if ($ImageCode == $_SESSION['authnum_session']) {
            ...
            $ServerAdmin = new AdminAdminModule();
