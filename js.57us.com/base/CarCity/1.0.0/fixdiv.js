W_creatLink("/base/CarCity/1.0.0/CarCity.css");
...
(function() {
    ...
    f = {
        ...
        hotTemplate: {
            container: '<div class="address_hot" style="display:none;top:0;" id="address_hot">{$text}</div>',
            ...
            if (f.hotData) {
                ...
                var a = f.hotTemplate.container.replaceWith({
                    text: [f.hotTemplate.title.replaceWith({
                        text: $$.module.address.source[o.source + "_keyWord"] || " \uff08\u53ef\u76f4\u63a5\u8f93\u5165\u57ce\u5e02\uff09"
