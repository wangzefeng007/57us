...
$(function () {
    ...
    $("#AddTag").click(function () {
        html = '<div class="inputBox">'+
            ...
            '<input type="text" name="" value="" placeholder="99.9%通过率" class="InsInput TipInput Tag">'+
            '</div>';
        $("#AddTag").before(html);
...
$(document).ready(function() {
    if(suffix == 'cn') {
        var InforUrl = "http://study.57us.cn/teachermanage/myinfoauditview/";
    } else if(suffix == 'com') {
        var InforUrl = "http://study.57us.com/teachermanage/myinfoauditview/";
    }else if(suffix == 'net'){
        var InforUrl = "http://study.57us.net/teachermanage/myinfoauditview/";
    }
