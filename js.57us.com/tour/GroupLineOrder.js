/**
 * Created by Foliage on 2016/8/25.
 */
$(function () {
    //协议选择
    ...
    $("#BackBtn").click(function () {
        ...
        var Back = '1';
        window.location.href = '/group/'+ProductId+'.html?Date='+Date+'&Back='+Back;
    })
    ...
    $("#paybtn").click(function () {
        ...
        //产品skuid数组
        var ProductSkuID=[];
        $(".RoomFree li").each(function () {
            ProductSkuID.push({'skuid':$(this).attr('data-id')})
        })
        var ajaxData = {
            'TourProductID':$("#ProductId").val(), //产品id
            'Date':$("#Date").val(), //出行时间
            'ProductSkuID':ProductSkuID, //产品skuid
            'Number':$("#PeopleNum").val(), //出行人数量
            'Travellers':roomnum, //旅行信息
            ...
            'MobileCountry':$("#country input").val(), //手机区号
