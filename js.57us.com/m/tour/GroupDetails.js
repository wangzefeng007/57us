...
$(function() {
    ...
    //显示头部
    $("#prodetail .content").on('scroll',function(){
        //显示头部
        if($(".content").scrollTop()>$(".ProdetailBox").offset().top){
    ...
    $(".nowOrder").on('click',function () {
        var TourProductID = $(this).attr('data-id');
        location.href="/group/choicedate/?TourProductID="+TourProductID;
    })
});